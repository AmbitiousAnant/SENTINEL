      ...
      <nav className="fixed left-0 top-0 h-full w-[280px] hidden md:flex flex-col border-r border-border bg-sidebar z-50">
        <div className="flex flex-col h-full py-10">
          ...
          <ul className="flex-1 space-y-1 mt-4">
            <li>
              <a className="flex items-center gap-3 px-4 py-3 text-primary font-bold border-l-4 border-primary bg-primary/10 hover:bg-accent/30 transition-colors" href="/dashboard/district">
